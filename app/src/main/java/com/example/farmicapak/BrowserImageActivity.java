...
public class BrowserImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        help.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(BrowserImageActivity.this,ContactUs.class));
            }
        });
    ...
    public void detailsFromGalery(View view) {
        fromGallery = true;
        startActivity(new Intent(BrowserImageActivity.this,WeedDetailsActivity.class));
    }
}
