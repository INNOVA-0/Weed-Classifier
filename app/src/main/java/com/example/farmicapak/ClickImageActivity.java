...
public class ClickImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        help.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                startActivity(new Intent(ClickImageActivity.this,ContactUs.class));


            }
        });

        clickImage=findViewById(R.id.btnCamera);
        camerapic=findViewById(R.id.ImageViewScan);
        classitext= findViewById(R.id.classificationLabel);
        details = findViewById(R.id.navigate_to_details_camera);
    ...
    public void detailsFromCamera(View view) {
        fromCamera= true;
        startActivity(new Intent(ClickImageActivity.this,WeedDetailsActivity.class));
    }
}